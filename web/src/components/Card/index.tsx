...
export default ({ title = "", subtitle = "", children = {}, enableButton = true }) => {
  return (
    <div class='p-8 relative'>
      {enableButton ? <div onClick={() => route('/web')} class='md:hidden shadow-m absolute text-gray-400 right-8 top-8 w-12 h-12 bg-grey-light rounded-full items-center justify-center flex'>
        <Icon name='close' />
      </div> : null }
