...
static be_define_const_map_slots(be_class_bytes_map) {
    { be_const_key(size, 12), be_const_func(m_size) },
    ...
    { be_const_key(geti, 9), be_const_func(m_geti) },
    { be_const_key(setbits, 2), be_const_closure(setbits_closure) },
    { be_const_key(tob64, 18), be_const_func(m_tob64) },
    { be_const_key(fromhex, 30), be_const_func(m_fromhex) },
    ...
    { be_const_key(fromstring, 29), be_const_func(m_fromstring) },
    { be_const_key(_X2E_X2E, 26), be_const_func(m_connect) },
