be_define_const_str(, "", 2166136261u, 0, 0, &be_const_str_exit);
be_define_const_str(_X21_X3D, "!=", 2428715011u, 0, 2, &be_const_str_endswith);
be_define_const_str(_X28_X29, "()", 685372826u, 0, 2, NULL);
be_define_const_str(_X2B, "+", 772578730u, 0, 1, &be_const_str_end);
be_define_const_str(_X2E_X2E, "..", 2748622605u, 0, 2, &be_const_str_module);
be_define_const_str(_X2Elen, ".len", 850842136u, 0, 4, &be_const_str_insert);
be_define_const_str(_X2Ep, ".p", 1171526419u, 0, 2, &be_const_str_getbits);
be_define_const_str(_X2Esize, ".size", 1965188224u, 0, 5, &be_const_str_counters);
be_define_const_str(_X3D_X3D, "==", 2431966415u, 0, 2, &be_const_str_acos);
be_define_const_str(__incr__, "__incr__", 3240913791u, 0, 8, &be_const_str_deg);
...
be_define_const_str(__upper__, "__upper__", 3612202883u, 0, 9, &be_const_str_getfloat);
be_define_const_str(_buffer, "_buffer", 2044888568u, 0, 7, &be_const_str_false);
be_define_const_str(_change_buffer, "_change_buffer", 2101848693u, 0, 14, &be_const_str_chdir);
be_define_const_str(abs, "abs", 709362235u, 0, 3, NULL);
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_allocs);
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_bytes);
be_define_const_str(addfloat, "addfloat", 937731078u, 0, 8, &be_const_str_escape);
be_define_const_str(allocated, "allocated", 429986098u, 0, 9, &be_const_str_caller);
be_define_const_str(allocs, "allocs", 1254752255u, 0, 6, &be_const_str_getcwd);
be_define_const_str(append, "append", 110723809u, 0, 6, &be_const_str_resize);
be_define_const_str(as, "as", 1579491469u, 67, 2, &be_const_str_remove);
be_define_const_str(asin, "asin", 4272848550u, 0, 4, &be_const_str_rand);
...
be_define_const_str(break, "break", 3378807160u, 58, 5, &be_const_str_ceil);
...
be_define_const_str(calldepth, "calldepth", 3122364302u, 0, 9, &be_const_str_int);
be_define_const_str(caller, "caller", 1794178658u, 0, 6, &be_const_str_isinstance);
...
be_define_const_str(chdir, "chdir", 806634853u, 0, 5, &be_const_str_pow);
be_define_const_str(class, "class", 2872970239u, 57, 5, &be_const_str_issubclass);
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_startswith);
be_define_const_str(classof, "classof", 1796577762u, 0, 7, &be_const_str_format);
be_define_const_str(clear, "clear", 1550717474u, 0, 5, &be_const_str_reallocs);
be_define_const_str(clock, "clock", 363073373u, 0, 5, &be_const_str_exists);
be_define_const_str(codedump, "codedump", 1786337906u, 0, 8, NULL);
be_define_const_str(collect, "collect", 2399039025u, 0, 7, &be_const_str_list);
be_define_const_str(compile, "compile", 1000265118u, 0, 7, NULL);
be_define_const_str(concat, "concat", 4124019837u, 0, 6, &be_const_str_push);
...
be_define_const_str(copy, "copy", 3848464964u, 0, 4, &be_const_str_count);
be_define_const_str(cos, "cos", 4220379804u, 0, 3, &be_const_str_cosh);
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, &be_const_str_size);
...
be_define_const_str(deg, "deg", 3327754271u, 0, 3, &be_const_str_value_error);
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, &be_const_str_setrange);
be_define_const_str(do, "do", 1646057492u, 65, 2, &be_const_str_isdir);
...
be_define_const_str(end, "end", 1787721130u, 56, 3, &be_const_str_geti);
be_define_const_str(endswith, "endswith", 790464931u, 0, 8, &be_const_str_member);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_path);
be_define_const_str(except, "except", 950914032u, 69, 6, &be_const_str_str);
be_define_const_str(exists, "exists", 1002329533u, 0, 6, &be_const_str_type);
be_define_const_str(exit, "exit", 3454868101u, 0, 4, &be_const_str_reverse);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_frees);
be_define_const_str(false, "false", 184981848u, 62, 5, &be_const_str_length_X20in_X20bits_X20must_X20be_X20between_X200_X20and_X2032);
be_define_const_str(find, "find", 3186656602u, 0, 4, NULL);
be_define_const_str(floor, "floor", 3102149661u, 0, 5, &be_const_str_keys);
be_define_const_str(for, "for", 2901640080u, 54, 3, &be_const_str_ismethod);
be_define_const_str(format, "format", 3114108242u, 0, 6, &be_const_str_pi);
be_define_const_str(frees, "frees", 2655040120u, 0, 5, &be_const_str_tob64);
be_define_const_str(fromb64, "fromb64", 2717019639u, 0, 7, &be_const_str_iter);
be_define_const_str(fromhex, "fromhex", 1847150394u, 0, 7, &be_const_str_isnan);
be_define_const_str(fromptr, "fromptr", 666189689u, 0, 7, &be_const_str_join);
be_define_const_str(fromstring, "fromstring", 610302344u, 0, 10, &be_const_str_imin);
be_define_const_str(gcdebug, "gcdebug", 227911486u, 0, 7, &be_const_str_try);
be_define_const_str(get, "get", 1410115415u, 0, 3, NULL);
be_define_const_str(getbits, "getbits", 3094168979u, 0, 7, &be_const_str_replace);
be_define_const_str(getcwd, "getcwd", 652026575u, 0, 6, NULL);
be_define_const_str(getfloat, "getfloat", 2820979603u, 0, 8, &be_const_str_tr);
be_define_const_str(geti, "geti", 2381006490u, 0, 4, &be_const_str_hex);
be_define_const_str(hex, "hex", 4273249610u, 0, 3, &be_const_str_lower);
be_define_const_str(if, "if", 959999494u, 50, 2, &be_const_str_setbytes);
be_define_const_str(imax, "imax", 3084515410u, 0, 4, &be_const_str_ismapped);
be_define_const_str(imin, "imin", 2714127864u, 0, 4, NULL);
be_define_const_str(import, "import", 288002260u, 66, 6, NULL);
be_define_const_str(incr, "incr", 482404207u, 0, 4, &be_const_str_return);
...
be_define_const_str(int, "int", 2515107422u, 0, 3, &be_const_str_while);
be_define_const_str(isdir, "isdir", 2340917412u, 0, 5, NULL);
be_define_const_str(isfile, "isfile", 3131505107u, 0, 6, &be_const_str_set);
...
be_define_const_str(ismethod, "ismethod", 3513438880u, 0, 8, &be_const_str_listdir);
be_define_const_str(isnan, "isnan", 2981347434u, 0, 5, NULL);
be_define_const_str(issubclass, "issubclass", 4078395519u, 0, 10, &be_const_str_sqrt);
be_define_const_str(item, "item", 2671260646u, 0, 4, NULL);
be_define_const_str(iter, "iter", 3124256359u, 0, 4, NULL);
be_define_const_str(join, "join", 3374496889u, 0, 4, &be_const_str_load);
be_define_const_str(keys, "keys", 4182378701u, 0, 4, &be_const_str_real);
be_define_const_str(length_X20in_X20bits_X20must_X20be_X20between_X200_X20and_X2032, "length in bits must be between 0 and 32", 2584509128u, 0, 39, &be_const_str_mkdir);
...
be_define_const_str(member, "member", 719708611u, 0, 6, &be_const_str_split);
be_define_const_str(members, "members", 937576464u, 0, 7, NULL);
be_define_const_str(mkdir, "mkdir", 2883839448u, 0, 5, &be_const_str_rad);
be_define_const_str(module, "module", 3617558685u, 0, 6, &be_const_str_varname);
...
be_define_const_str(open, "open", 3546203337u, 0, 4, &be_const_str_upvname);
...
be_define_const_str(remove, "remove", 3683784189u, 0, 6, &be_const_str_traceback);
be_define_const_str(replace, "replace", 2704835779u, 0, 7, NULL);
be_define_const_str(resize, "resize", 3514612129u, 0, 6, &be_const_str_tolower);
...
be_define_const_str(setbits, "setbits", 2762408167u, 0, 7, &be_const_str_setfloat);
be_define_const_str(setbytes, "setbytes", 197507254u, 0, 8, NULL);
be_define_const_str(setfloat, "setfloat", 2799488807u, 0, 8, &be_const_str_upper);
be_define_const_str(seti, "seti", 1500556254u, 0, 4, &be_const_str_splitext);
...
be_define_const_str(sinh, "sinh", 282220607u, 0, 4, &be_const_str_solidified);
...
be_define_const_str(splitext, "splitext", 2150391934u, 0, 8, &be_const_str_toptr);
be_define_const_str(sqrt, "sqrt", 2112764879u, 0, 4, NULL);
be_define_const_str(srand, "srand", 465518633u, 0, 5, NULL);
be_define_const_str(startswith, "startswith", 4221853948u, 0, 10, &be_const_str_top);
be_define_const_str(static, "static", 3532702267u, 71, 6, NULL);
be_define_const_str(str, "str", 3259748752u, 0, 3, &be_const_str_tanh);
be_define_const_str(super, "super", 4152230356u, 0, 5, &be_const_str_time);
be_define_const_str(system, "system", 1226705564u, 0, 6, &be_const_str_tobool);
